(() => {
  ...
  var require_simplex_noise = __commonJS((exports, module) => {
    (function() {
      "use strict";
...
`;
  var RuntimeLogo = class extends HTMLElement {
    path;
    root;
    simplex;
    points;
    ...
    constructor() {
      ...
      this.simplex = new import_simplex_noise.default();
      this.points = this.createPoints();
      this.root.style.setProperty("--desktop-runtime-fonts", '-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Oxygen-Sans,Ubuntu,Cantarell,"Helvetica Neue",sans-serif');
      this.animate();
      this.onmouseenter = () => this.noiseStep = 2e-3;
      this.onmouseleave = () => this.noiseStep = 5e-3;
      this.onclick = () => this.hueNoiseOffset = this.hueNoiseOffset + 20;
      this.addEventListener("dblclick", () => {
        shadowRoot.querySelector("#runtime").innerHTML = shadowRoot.querySelector("#runtime").innerHTML === "Runtime" ? "Funtime" : "Runtime";
      });
    }
    animate() {
      ...
      this.root.style.setProperty("--desktop-runtime-startColor", `hsl(${hue}, 100%, 75%)`);
      this.root.style.setProperty("--desktop-runtime-stopColor", `hsl(${hue + 100}, 100%, 75%)`);
